                    ...
                    <div class="ecommerce-widget">
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12" style="text-align: center;">
                                <div class="card">
                                    <h5 class="card-header">Recibos sin Validez: <p style="color: red; font-size: 1.5em;">{{ count($bills) }}</p></h5>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($bills as $bill)
                                                        ...
                                                        @endif
                                                                ...
                                                                <td><span class="badge-dot badge-danger mr-1"></span><a style="text-decoration: underline;" href="{{url('confirmar',Crypt::encrypt($bill->id))}}">{{ $bill->estado }}</a></td>
                                                            </tr>
                                                            @endif   
                                                        @endif
                                                    @endforeach
