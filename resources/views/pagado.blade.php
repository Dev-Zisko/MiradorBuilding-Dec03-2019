                    ...
                    <div class="ecommerce-widget">
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12" style="text-align: center;">
                                <div class="card">
                                    <h5 class="card-header">Recibos Pagados: <p style="color: green; font-size: 1.5em;">{{ $contbills }}</p></h5>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($bills as $bill)
                                                        ...
                                                        @endif
                                                                ...
                                                                <td><span class="badge-dot badge-success mr-1"></span><a style="text-decoration: underline;" href="{{url('confirmar',Crypt::encrypt($bill->id))}}">Pagado</a></td>
                                                            </tr>
                                                            @endif   
                                                        @endif
                                                    @endforeach
