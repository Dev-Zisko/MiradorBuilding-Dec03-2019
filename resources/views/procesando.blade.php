                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Recibos del Edificio</h2>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <div class="ecommerce-widget">
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12" style="text-align: center;">
                                <div class="card">
                                    <h5 class="card-header">Recibos sin Verificar: <p style="color: orange; font-size: 1.5em;">{{ count($bills) }}</p></h5>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($bills as $bill)
                                                        ...
                                                        @endif
                                                                ...
                                                                <td>{{ $bill->fechatrans }}</td>
                                                                <td><span class="badge-dot badge-brand mr-1"></span><a style="text-decoration: underline;" href="{{url('confirmar',Crypt::encrypt($bill->id))}}">Por Verificar</a></td>
                                                            </tr>
                                                            @endif   
                                                        @endif
                                                    @endforeach
